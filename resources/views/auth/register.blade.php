                ...
                <div class="c-content">
                    ...
                    <ul class="c-lists">
                        <li class="form-group{{ $errors->has('name') ? ' has-error' : '' }} c-list">
                            <label class="c-label" for="name">ユーザネーム <span class="c-required">*</span></label>
                        ...
                        <li class="c-list">
                            <label class="c-label" for="password-confirm">パスワード(再入力) <span class="c-required">*</span></label>
